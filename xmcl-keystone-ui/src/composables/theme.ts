...
export function getDefaultTheme(): UIThemeDataV1 {
  return {
    ...
    colors: {
      // ChaldLauncher palette: dark graphite base, single turquoise accent.
      lightAppBarColor: '#f2f3f2FF',
      lightSideBarColor: '#FFFFFFFF',
      darkAppBarColor: '#0a0c0bFF',
      darkSideBarColor: '#0a0c0b8C',
      darkPrimaryColor: '#14b8a6',
      darkBackground: '#0b0d0cF2',
      darkInfoColor: '#3b82f6',
      darkErrorColor: '#f43f5e',
      darkWarningColor: '#f59e0b',

      darkSuccessColor: '#22c55e',
      darkAccentColor: '#2dd4bf',
      darkCardColor: '#101312d9',
      lightPrimaryColor: '#0d9488',
      lightBackground: '#FAFAFA',
      lightInfoColor: '#2563eb',
      lightErrorColor: '#e11d48',
      lightWarningColor: '#d97706',
      lightSuccessColor: '#16a34a',
      lightAccentColor: '#14b8a6',
      lightCardColor: '#ffffffb8' },
