...
/** Border radius (px). Windows 11 Fluent 2 uses a consistent ~8px control radius. */
export const DEFAULT_SURFACE_RADIUS = 8
/** Dialog shell radius (px). Fluent 2 dialogs use ~8px, not a big pill radius. */
export const DEFAULT_SURFACE_DIALOG_RADIUS = 8

/** Vuetify `rounded` prop value equivalent to `DEFAULT_SURFACE_RADIUS`. */
export const DEFAULT_SURFACE_RADIUS_PROP = 'lg' as const

export const DEFAULT_SURFACE_BORDER = '1px solid rgba(255, 255, 255, 0.08)'
export const DEFAULT_SURFACE_SHADOW = '0 8px 16px 0 rgba(0, 0, 0, 0.28)'

/** Mica-style translucent background shared by dialogs, menus and popovers. */
export const DEFAULT_SURFACE_BG = 'rgba(var(--v-theme-surface), 0.72)'
export const DEFAULT_SURFACE_BLUR = 32

/** Menu-only: inner padding and list-item radius. */
export const DEFAULT_SURFACE_MENU_PADDING = 4
export const DEFAULT_SURFACE_MENU_ITEM_RADIUS = 4
/** Shared tooltip bubble radius. */
export const DEFAULT_SURFACE_TOOLTIP_RADIUS = 4
/** Pill button radius — reserved for explicit capsule elements (nav rail selection), not the default anymore. */
export const DEFAULT_SURFACE_PILL_RADIUS = 9999
/**
 * Default button radius as a Vuetify `rounded` prop value (NOT pixels).
 * Fluent 2 controls use a small ~4px radius — rounded but not sharp, not a pill.
 */
...
export const DEFAULT_CARD_RADIUS = 8             // tier 1: HomeCard, SettingCard
export const DEFAULT_CARD_SUBSECTION_RADIUS = 8  // tier 2: nested sections
export const DEFAULT_CARD_ITEM_RADIUS = 4        // tier 3: list / compact tiles
...
export const DEFAULT_CARD_ROW_BORDER = '1px solid rgba(255, 255, 255, 0.06)'
export const DEFAULT_CARD_ROW_BORDER_HOVER = '1px solid rgba(var(--v-theme-primary), 0.4)'
...
// Info / frosted panels — Fluent-style Mica panel pattern used inside dialogs (Feedback / Export / Friends).
export const DEFAULT_PANEL_RADIUS = 8
export const DEFAULT_PANEL_BG = 'rgba(255, 255, 255, 0.04)'
export const DEFAULT_PANEL_BORDER = '1px solid rgba(255, 255, 255, 0.08)'

// Prominent cards — Store detail / market tile / large feature cards.
// Same radius as panels (8px) but no built-in bg/border so the host
// surface (often Vuetify's default) shows through.
export const DEFAULT_CARD_PROMINENT_RADIUS = 8
...
export const DEFAULT_CARD_CLICKABLE_RADIUS = 8
export const DEFAULT_CARD_CLICKABLE_BG = 'rgb(var(--v-theme-surface))'
export const DEFAULT_CARD_CLICKABLE_BORDER = '1px solid rgba(255, 255, 255, 0.06)'
export const DEFAULT_CARD_CLICKABLE_BORDER_HOVER = '1px solid rgba(var(--v-theme-primary), 0.35)'
export const DEFAULT_CARD_CLICKABLE_SHADOW_HOVER = '0 4px 12px 0 rgba(0, 0, 0, 0.24)'
/** Hover lift in px (negative = upward). Fluent 2 keeps hover motion subtle. */
export const DEFAULT_CARD_CLICKABLE_LIFT = -2
