...
/*
 * Microsoft has closed the free registration of new Azure AD apps for
 * Minecraft/Xbox Live API access (see https://aka.ms/AppRegInfo).
 * New custom Azure apps always receive HTTP 403 "Invalid app registration"
 * from api.minecraftservices.com/authentication/login_with_xbox.
 *
 * We use the known-working client ID of the official Minecraft Launcher,
 * which was registered before Microsoft restricted new applications.
 * This is a standard practice in the launcher community (Prism Launcher,
 * MultiMC and others do the same).
 *
 * Device code flow is forced because we cannot register our own redirect
 * URIs in Microsoft's first-party app registration.
 */
